...
export default function SitusAdd() {
  ...
  const createSitus = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/Situs", {
        nama,
        namalain,
        provinsi,
        kota,
  ...
  return (
    <div className="font-romans text-secondary py-3 px-2">
      ...
      <div>
        <form onSubmit={createSitus} className="w-full mb-10">
