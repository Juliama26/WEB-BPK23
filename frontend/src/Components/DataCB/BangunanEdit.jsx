...
export default function BangunanEdit() {
  ...
  useEffect(() => {
    const getBangunanID = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5000/Bangunan/${id}`
        );
  ...
  return (
    <div className="font-romans text-secondary py-3 px-2">
      ...
      <div>
        <form onSubmit={updateBangunan} className="w-full mb-10">
