...
export default function KawasanAdd() {
  ...
  const createKawasan = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/Kawasan", {
        nama,
        namalain,
        provinsi,
        kota,
  ...
  return (
    <div className="font-romans text-secondary py-3 px-2">
      ...
      <div>
        <form onSubmit={createKawasan} className="w-full mb-10">
