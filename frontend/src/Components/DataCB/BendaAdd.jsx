...
export default function BendaAdd() {
  ...
  const createBenda = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:5000/benda", {
        nama,
        namalain,
        provinsi,
        kota,
  ...
  return (
    <div className="font-romans text-secondary py-3 px-2">
      ...
      <div>
        <form onSubmit={createBenda} className="w-full mb-10">
